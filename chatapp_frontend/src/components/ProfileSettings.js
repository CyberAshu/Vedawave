...
import { 
  ...
  MapPin, Phone, Github, Twitter, Linkedin, Globe, Check, AlertCircle, 
  Eye, Bell, Clock, MessageCircle, Users, Settings
} from 'lucide-react';
...
const ProfileSettings = ({ currentUser, onLogout, onBackClick }) => {
  ...
  const { theme, setTheme, actualTheme, isSystem } = useTheme();
  ...
  const renderGeneralTab = () => (
    <div className="space-y-8">
      ...
      {isEditing && (
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            <h4 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Social Links</h4>
          ...
          <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 mt-8">
            ...
            >
              ...
              disabled={loading}
              className="flex items-center justify-center px-4 sm:px-6 py-3 bg-gray-500 dark:bg-gray-600 text-white rounded-lg hover:bg-gray-600 dark:hover:bg-gray-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-4 sm:p-6">
          <div className="flex items-center space-x-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400"></p>
              <p className="text-sm sm:text-lg font-semibold text-gray-800 dark:text-gray-200 truncate">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-4 sm:p-6 sm:col-span-2 lg:col-span-1">
          <div className="flex items-center space-x-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Custom Status</p>
              <p className="text-sm sm:text-lg font-semibold text-gray-800 dark:text-gray-200 truncate">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <h4 className="text-lg font-medium text-gray-800 dark:text-gray-200">Message Notifications</h4>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg space-y-3 sm:space-y-0">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <p className="font-medium text-gray-800 dark:text-gray-200 text-sm sm:text-base">New Messages</p>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Get notified when you receive new messages</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-gray-800 dark:text-gray-200">Friend Requests</p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Get notified when someone sends you a friend request</p>
                </div>
              </div>
            ...
            <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-700">
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium text-blue-800 dark:text-blue-200">Test Notifications</p>
                  <p className="text-sm text-blue-600 dark:text-blue-400">Send a test notification to verify your settings</p>
                </div>
                <button
                  onClick={() => {
                  ...
                  className="px-4 py-2 bg-blue-500 dark:bg-blue-600 text-white rounded-lg hover:bg-blue-600 dark:hover:bg-blue-700 transition-colors text-sm"
                >
                  Test Now
                </button>
              </div>
          ...
          {/* Email Notifications */}
          <div className="space-y-4">
            <h4 className="text-lg font-medium text-gray-800 dark:text-gray-200">Email Notifications</h4>
  ...
  const renderPrivacyTab = () => (
    <div className="space-y-6">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-medium text-gray-800 dark:text-gray-200">Profile Visibility</p>
                <p className="text-sm text-gray-600 dark:text-gray-400">Who can see your profile</p>
              </div>
            </div>
            <select 
              className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-medium text-gray-800 dark:text-gray-200">Online Status</p>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-medium text-gray-800 dark:text-gray-200">Last Seen</p>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-medium text-gray-800 dark:text-gray-200">Read Receipts</p>
      ...
      {/* Danger Zone */}
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-red-200 dark:border-red-600 shadow-sm p-6">
        ...
        <div className="space-y-4">
          <div className="p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-700">
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium text-red-800 dark:text-red-300">Change Password</p>
                <p className="text-sm text-red-600 dark:text-red-400">Update your account password</p>
              </div>
              <button
  ...
  const renderAppearanceTab = () => (
    <div className="space-y-6">
      <div className="bg-white dark:bg-gray-800 rounded-2xl border shadow-sm p-6">
        <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-6">Appearance Settings</h3>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center space-x-3 cursor-pointer">
                <input
                  ...
                  checked={theme === 'light'}
                  onChange={(e) => {
                    console.log('ProfileSettings: Theme change to', e.target.value);
              ...
              <label className="flex items-center space-x-3 cursor-pointer">
                <input
                  ...
                  onChange={(e) => {
                    console.log('ProfileSettings: Theme change to', e.target.value);
                    setTheme(e.target.value);
                    setSuccess('Theme changed to System!');
                  }}
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                />
                <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-medium text-gray-800 dark:text-gray-200">Font Size</p>
    ...
    <div className="flex flex-col h-full bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex items-center justify-between p-4 sm:p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <h1 className="text-lg sm:text-2xl font-bold text-gray-800 dark:text-gray-100">Profile Settings</h1>
        </div>
        <button
          onClick={onLogout}
          className="flex items-center px-3 py-2 sm:px-4 bg-red-500 dark:bg-red-600 text-white rounded-lg hover:bg-red-600 dark:hover:bg-red-700 transition-colors text-sm"
        >
      ...
      {(success || error) && (
        <div className="mx-4 sm:mx-6 mt-4">
          {success && (
            <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg p-3 sm:p-4 flex items-center">
              <Check className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 dark:text-green-400 mr-2 sm:mr-3 flex-shrink-0" />
              <p className="text-xs sm:text-sm text-green-700 dark:text-green-300">{success}</p>
            </div>
          )}
          {error && (
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-lg p-3 sm:p-4 flex items-center">
              <AlertCircle className="w-4 h-4 sm:w-5 sm:h-5 text-red-600 dark:text-red-400 mr-2 sm:mr-3 flex-shrink-0" />
